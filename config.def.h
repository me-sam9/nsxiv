...
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "gray90" };
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "GohuFont uni11 Nerd Font Mono:monospace:pixelsize=22:antialias=false:autohint=true" };
